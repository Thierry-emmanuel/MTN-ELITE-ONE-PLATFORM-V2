...
const STATUS_MAP: Record<string, string> = {
  ...
  IN_REVIEW: 'bg-amber-500/10 border border-amber-500/25 text-amber-400',
  NEEDS_CHANGES: 'bg-red-500/10 border border-red-500/25 text-red-400',
  APPROVED:  'bg-blue-500/10 border border-blue-500/25 text-blue-400',
  ARCHIVED:  'bg-white/5 border border-white/8 text-white/30',
