  ...
  return (
    <section ref={ref} className="container py-6 lg:py-8">
      <motion.div
        ...
        className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2.5 md:gap-3"
      >
        {/* Stat cards */}
        {stats.map((s) => (
          <motion.div
            ...
            className="group bg-gradient-card border border-border rounded-xl p-4 hover:border-white/20 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-elegant cursor-default"
          >
            <div
              className="h-8 w-8 rounded-lg grid place-items-center mb-3 transition-transform duration-300 group-hover:scale-110"
              style={{ background: `${s.color}18`, color: s.color }}
            >
              <s.icon className="h-3.5 w-3.5" />
            </div>
            <div className="font-display text-2xl lg:text-3xl text-foreground tabular-nums">{s.value}</div>
        ...
        <motion.div
          variants={itemVariants}
          className="col-span-2 sm:col-span-1 group relative bg-gradient-card border border-accent/30 rounded-xl p-4 overflow-hidden hover:border-accent/60 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-gold cursor-default"
        >
            ...
            <div className="flex items-center gap-2.5">
              <div className="relative shrink-0">
                <img
                  ...
                  alt="Top scorer"
                  loading="lazy"
                  className="h-10 w-10 rounded-lg object-cover ring-2 ring-accent/40 group-hover:ring-accent/70 transition-all"
                />
        ...
        <motion.div
          variants={itemVariants}
          className="col-span-2 sm:col-span-3 lg:col-span-1 group relative bg-gradient-card border border-primary/30 rounded-xl p-4 overflow-hidden hover:border-primary/60 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-elegant cursor-default"
        >
          ...
          <div className="relative">
            ...
            <div className="mt-2.5 flex gap-1">
              {["W", "W", "D", "W", "W"].map((r, i) => (
                <div
                  key={i}
                  className={`flex-1 h-1 rounded-full ${r === "W" ? "bg-win" : r === "D" ? "bg-draw" : "bg-loss"}`}
                />
              ))}
            </div>
          </div>
