        ...
        {results.map((r, idx) => {
          ...
          return (
            <motion.div
              ...
              className="group relative bg-surface/60 border border-border rounded-xl p-4 flex items-center gap-3 hover:bg-surface hover:border-white/15 transition-all duration-200 cursor-pointer overflow-hidden"
            >
              {/* Win indicator line */}
              ...
              <div className="text-[10px] text-muted-foreground uppercase tracking-wider w-12 shrink-0 pl-1">
                {r.date}
              </div>
              ...
              <div className="flex-1 grid grid-cols-[1fr_auto_1fr] items-center gap-3 min-w-0">
                ...
                {/* Score */}
                <div className="flex items-center gap-1.5 font-display text-lg tabular-nums px-1 shrink-0">
